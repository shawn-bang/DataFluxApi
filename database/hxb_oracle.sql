...
-----------------------------------------------------------------------------------------
-- DDL comment: request info and response info relation
...
comment on column af_risk_level_settings.result_type is 'EMPTY(返回NULL),HIT(命中),UNHIT(未命中)';
...
-- if exist table af_request_appinfo_his_hot
DROP TABLE af_request_appinfo_his_hot cascade constraints;
...
comment on column  af_request_appinfo_his_hot.c1_idnbr is '主卡申请人证件号码*';
comment on column  af_request_appinfo_his_hot.c1_idtype is '主卡申请人证件类型';
comment on column  af_request_appinfo_his_hot.c1_mobile is '主卡申请人手机号码*';
comment on column  af_request_appinfo_his_hot.c1_remobil is '直系亲属手机';
comment on column  af_request_appinfo_his_hot.c1_rename is '直系亲属姓名';
comment on column  af_request_appinfo_his_hot.c1_reship is '直系亲属关系';
...
comment on column  af_request_appinfo_his_hot.c4_abname is '推广人姓名';
comment on column  af_request_appinfo_his_hot.c4_abuser is '推广人编号';
comment on column  af_request_appinfo_his_hot.c4_apsour is '推广进件来源';
comment on column  af_request_appinfo_his_hot.c4_cycadd1 is '账单邮寄地址1*';
comment on column  af_request_appinfo_his_hot.c2_gender is '附卡申请人性别*';
...
comment on column  af_request_appinfo_his_hot.mate_name is '配偶_姓名';
comment on column  af_request_appinfo_his_hot.industry_type1 is '行业1';
comment on column  af_request_appinfo_his_hot.industry_type2 is '行业2';
comment on column  af_request_appinfo_his_hot.industry_type3 is '行业3';
comment on column  af_request_appinfo_his_hot.industry_type4 is '行业4';
comment on column  af_request_appinfo_his_hot.industry_type5 is '行业5';
comment on column  af_request_appinfo_his_hot.first_deposit_ym is '初缴月份';
comment on column  af_request_appinfo_his_hot.no_pd_card_loan_corp_number is '未销户贷记卡_贷款法人机构数/发卡法人机构数';
comment on column  af_request_appinfo_his_hot.no_pd_card_loan_org_number is '未销户贷记卡_贷款机构数/发卡机构数';
...
-- if exist table af_request_appinfo_his_cold
DROP TABLE af_request_appinfo_his_cold cascade constraints;
-- create table af_request_appinfo_his_cold
create table af_request_appinfo_his_cold(
  app_id VARCHAR2(20) NOT NULL,
  app_code NUMBER(10),
  app_flag NUMBER(1),
...
comment on table af_request_appinfo_his_cold is '请求报文applicants信息表(冷字段部分)';
comment on column  af_request_appinfo_his_cold.app_id is '申请件编号';
comment on column  af_request_appinfo_his_cold.app_code is '申请书编号';
comment on column  af_request_appinfo_his_cold.app_flag is '主卡/副卡标志';
comment on column  af_request_appinfo_his_cold.app_prod is '申请卡产品';
comment on column  af_request_appinfo_his_cold.c1_carbrnd is '自购车辆品牌';
comment on column  af_request_appinfo_his_cold.c1_cardate is '自购车辆购买时间';
comment on column  af_request_appinfo_his_cold.c1_cardnbr is '主卡卡号';
comment on column  af_request_appinfo_his_cold.c1_carnbr is '自购车辆车牌号';
...
comment on column  af_request_appinfo_his_cold.c1_coduty is '公司职务';
comment on column  af_request_appinfo_his_cold.c1_coext is '公司电话分机';
comment on column  af_request_appinfo_his_cold.c1_cokind is '公司性质';
comment on column  af_request_appinfo_his_cold.c1_colevl is '公司规模';
comment on column  af_request_appinfo_his_cold.c1_copost is '类型4（公司）邮政编码';
comment on column  af_request_appinfo_his_cold.c1_coyr is '公司服务年数';
comment on column  af_request_appinfo_his_cold.c1_earn is '主卡申请人年收入';
comment on column  af_request_appinfo_his_cold.c1_email is '主卡申请人E-mail地址';
...
comment on column  af_request_appinfo_his_cold.c1_idadd2 is '类型2（户籍）地址区段2';
comment on column  af_request_appinfo_his_cold.c1_idadd3 is '类型2（户籍）地址区段3';
comment on column  af_request_appinfo_his_cold.c1_idadd4 is '类型2（户籍）地址区段4';
comment on column  af_request_appinfo_his_cold.c1_idpost is '类型2（户籍）邮政编码';
comment on column  af_request_appinfo_his_cold.c1_marst is '主卡申请人婚姻状况';
...
comment on column  af_request_appinfo_his_cold.c1_statemen_check is '申请人个人声明抄录文字准确性校验';
comment on column  af_request_appinfo_his_cold.c4_abacces is '渠道代码';
comment on column  af_request_appinfo_his_cold.c4_abbrnch is '省市代码';
comment on column  af_request_appinfo_his_cold.c4_abphon is '推广人联系电话';
comment on column  af_request_appinfo_his_cold.c4_abtype is '推广人方式';
comment on column  af_request_appinfo_his_cold.c4_apbatch is '申请书团办编号';
comment on column  af_request_appinfo_his_cold.c4_clyn1 is '主卡存在车辆行驶证信息';
comment on column  af_request_appinfo_his_cold.c4_cycadd2 is '账单邮寄地址2';
comment on column  af_request_appinfo_his_cold.c4_fcodat is '主卡申请人首次参加工作时间';
comment on column  af_request_appinfo_his_cold.c4_othcard is '主卡申请人其他信用卡卡号';
comment on column  af_request_appinfo_his_cold.c4_othcred is '主卡申请人其他信用卡信用额度';
comment on column  af_request_appinfo_his_cold.c4_othtype is '主卡申请人其他信用卡类型';
comment on column  af_request_appinfo_his_cold.c4_reccard is '推荐人卡号';
comment on column  af_request_appinfo_his_cold.c4_recemp is '推荐人工号';
comment on column  af_request_appinfo_his_cold.c4_recname is '推荐人姓名';
comment on column  af_request_appinfo_his_cold.c4_relmod is '推荐方式';
comment on column  af_request_appinfo_his_cold.c4_relship is '推荐人与申请人关系';
comment on column  af_request_appinfo_his_cold.c4_rushflg is '快速发卡标志';
comment on column  af_request_appinfo_his_cold.c4_sign_flag is '主卡申请人亲见亲签标志';
comment on column  af_request_appinfo_his_cold.c5_abarea is '区域代码';
comment on column  af_request_appinfo_his_cold.c5_abcode is '推广机构号';
comment on column  af_request_appinfo_his_cold.c5_abteam is '团队代码';
comment on column  af_request_appinfo_his_cold.c5_abtype is '推广人方式2';
comment on column  af_request_appinfo_his_cold.c5_cardto1 is '主卡卡片寄送地址类型';
comment on column  af_request_appinfo_his_cold.c5_comnm2p is '单位名称行2(主卡)';
comment on column  af_request_appinfo_his_cold.c5_idte1 is '主卡证件有效期';
comment on column  af_request_appinfo_his_cold.c5_qq_nbr1 is '主卡申请人QQ号码';
comment on column  af_request_appinfo_his_cold.c5_regdte1 is '车辆行驶证信注册日期（主卡）';
comment on column  af_request_appinfo_his_cold.c5_weixin_nbr1 is '主卡申请人微信号码';
comment on column  af_request_appinfo_his_cold.crt_date is '创建日期';
comment on column  af_request_appinfo_his_cold.primary_crt_time is '创建时间';
comment on column  af_request_appinfo_his_cold.czfq_match is '配发财智分期标志';
...
comment on column  af_request_appinfo_his_cold.lst_upd_date is '最后一次修改日期';
comment on column  af_request_appinfo_his_cold.lst_upd_time is '最后一次修改时间';
comment on column  af_request_appinfo_his_cold.lst_upd_user is '最后修改人';
comment on column  af_request_appinfo_his_cold.main_card_sts is '主卡状态';
comment on column  af_request_appinfo_his_cold.matching_card_flag is '双进件套卡标志';
comment on column  af_request_appinfo_his_cold.aml_flag is '是否命中反洗钱名单';
comment on column  af_request_appinfo_his_cold.aml_risk_level is '反洗钱风险等级';
comment on column  af_request_appinfo_his_cold.remain_bk_acc_status is '存量标准卡账户状态';
comment on column  af_request_appinfo_his_cold.remian_ydj_acc_status is '存量易达金卡账户状态';
comment on column  af_request_appinfo_his_cold.paymt_yn is '是否关联还款';
comment on column  af_request_appinfo_his_cold.quick_card_flag is '审批系统快速发卡标志';
comment on column  af_request_appinfo_his_cold.ydj_flag is '易达金标识，1为易达金，2为非易达金';
comment on column  af_request_appinfo_his_cold.info_flag is '京东卡-信息验证标识';
comment on column  af_request_appinfo_his_cold.credit_score is '小白信用分';
comment on column  af_request_appinfo_his_cold.buy_cycle is '网购账龄';
comment on column  af_request_appinfo_his_cold.use_active is '用户活跃度';
comment on column  af_request_appinfo_his_cold.buy_levle is '购买力等级';
comment on column  af_request_appinfo_his_cold.is_usename_whtname is '用户填写姓名与白条激活姓名是否一致';
comment on column  af_request_appinfo_his_cold.is_usetel_whttel is '用户填写手机号与白条激活手机是否一致';
comment on column  af_request_appinfo_his_cold.is_useidno_whtidno is '用户填写身份证号与白条激活身份证号是否一致';
comment on column  af_request_appinfo_his_cold.is_usetel_malltel is '用户填写手机号与商城注册手机是否一致';
comment on column  af_request_appinfo_his_cold.is_black_idno is '身份证号是否黑名单';
comment on column  af_request_appinfo_his_cold.wht_limit is '白条额度';
comment on column  af_request_appinfo_his_cold.wht_usetype is '白条用户类别';
comment on column  af_request_appinfo_his_cold.wht_refusetype is '白条拒绝原因类别';
comment on column  af_request_appinfo_his_cold.isdue_currwht is '白条当前是否逾期';
comment on column  af_request_appinfo_his_cold.wht_maxhis_duedays is '白条历史最高逾期天数';
comment on column  af_request_appinfo_his_cold.promote_company is '第三方公司名称';
...
comment on column  af_request_appinfo_his_cold.query_result is '查询结果';
comment on column  af_request_appinfo_his_cold.query_status is '查询状态';
comment on column  af_request_appinfo_his_cold.rec_status is '记录状态';
comment on column  af_request_appinfo_his_cold.schooltrade is '学校性质(公办、民办等)';
comment on column  af_request_appinfo_his_cold.schooltype is '毕业院校类型';
comment on column  af_request_appinfo_his_cold.specialityname is '专业';
comment on column  af_request_appinfo_his_cold.studyresult is '毕业结论';
comment on column  af_request_appinfo_his_cold.studystyle is '学历类型';
comment on column  af_request_appinfo_his_cold.username is '姓名';
comment on column  af_request_appinfo_his_cold.c2_birth is '附卡申请人出生日期*';
comment on column  af_request_appinfo_his_cold.c2_cname is '附卡申请人中文姓名*';
comment on column  af_request_appinfo_his_cold.c2_cocode is '附卡申请人公司行业类别码';
comment on column  af_request_appinfo_his_cold.c2_codept is '附卡申请人公司部门';
comment on column  af_request_appinfo_his_cold.c2_coduty is '附卡申请人公司部门';
comment on column  af_request_appinfo_his_cold.c2_coext is '附卡申请人公司电话分机';
comment on column  af_request_appinfo_his_cold.c2_cokind is '附卡申请人公司性质';
comment on column  af_request_appinfo_his_cold.c2_coname is '附卡申请人公司全称';
comment on column  af_request_appinfo_his_cold.c2_cotel is '附卡申请人公司电话';
comment on column  af_request_appinfo_his_cold.c2_coyr is '附卡申请人公司服务年数';
comment on column  af_request_appinfo_his_cold.c2_earn is '附卡申请人年收入';
comment on column  af_request_appinfo_his_cold.c2_email is '附卡申请人E-mail地址';
comment on column  af_request_appinfo_his_cold.c2_ename is '附卡申请人英文姓名';
comment on column  af_request_appinfo_his_cold.c2_hmare is '附卡申请人家庭电话区号*';
comment on column  af_request_appinfo_his_cold.c2_hmtel is '附卡申请人家庭电话*';
comment on column  af_request_appinfo_his_cold.c2_iddt2 is '附卡证件起始日期';
comment on column  af_request_appinfo_his_cold.c2_marst is '附卡申请人婚姻状况';
comment on column  af_request_appinfo_his_cold.c2_mobile is '附卡申请人手机号码*';
comment on column  af_request_appinfo_his_cold.c2_nation is '附卡申请人国籍';
comment on column  af_request_appinfo_his_cold.c2_relship is '附卡与主卡关系';
comment on column  af_request_appinfo_his_cold.c2_title is '附卡申请人岗位';
comment on column  af_request_appinfo_his_cold.c5_idte2 is '附卡证件有效期';
comment on column  af_request_appinfo_his_cold.c1_credpct is '附卡额度占主卡额度百分比';
comment on column  af_request_appinfo_his_cold.c5_qq_nbr2 is '附卡申请人QQ号码';
comment on column  af_request_appinfo_his_cold.c5_weixin_nbr2 is '附卡申请人微信号码';
comment on column  af_request_appinfo_his_cold.c6_rel_flag1 is '主卡申请人关联方声明';
comment on column  af_request_appinfo_his_cold.c6_rel_flag2 is '附卡申请人关联方声明';
comment on column  af_request_appinfo_his_cold.second_crt_time is '创建时间';
comment on column  af_request_appinfo_his_cold.series_id2 is '附卡套卡标识';
comment on column  af_request_appinfo_his_cold.brcreditpoint is '百融征信局评分';
comment on column  af_request_appinfo_his_cold.br_crt_time is '创建时间';
comment on column  af_request_appinfo_his_cold.sl_cell_bank_bad is '通过手机号查询银行(含信用卡)不良 ';
comment on column  af_request_appinfo_his_cold.sl_cell_bank_fraud is '通过手机号查询银行(含信用卡)资信不佳 ';
comment on column  af_request_appinfo_his_cold.sl_cell_bank_lost is '通过手机号查询银行(含信用卡)失联 ';
comment on column  af_request_appinfo_his_cold.sl_cell_bank_overdue is '通过手机号查询银行(含信用卡)短时逾期 ';
comment on column  af_request_appinfo_his_cold.sl_cell_bank_refuse is '通过手机号查询银行(含信用卡)拒绝 ';
comment on column  af_request_appinfo_his_cold.sl_cell_nbank_p2p_fraud is '通过手机号查询非银-P2P资信不佳 ';
comment on column  af_request_appinfo_his_cold.sl_cell_nbank_p2p_overdue is '通过手机号查询非银-P2P短时逾期 ';
comment on column  af_request_appinfo_his_cold.sl_id_abnormal is '通过身份证号查询高危行为';
comment on column  af_request_appinfo_his_cold.sl_id_bank_bad is '通过身份证号查询银行(含信用卡)不良 ';
comment on column  af_request_appinfo_his_cold.sl_id_bank_fraud is '通过身份证号查询银行(含信用卡)资信不佳 ';
comment on column  af_request_appinfo_his_cold.sl_id_bank_lost is '通过身份证号查询银行(含信用卡)失联 ';
comment on column  af_request_appinfo_his_cold.sl_id_bank_overdue is '通过身份证号查询银行(含信用卡)短时逾期 ';
comment on column  af_request_appinfo_his_cold.sl_id_bank_refuse is '通过身份证号查询银行(含信用卡)拒绝 ';
comment on column  af_request_appinfo_his_cold.sl_id_court_bad is '通过身份证号查询法院失信人';
comment on column  af_request_appinfo_his_cold.sl_id_court_executed is '通过身份证号查询法院被执行人';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_ca_bad is '通过身份证号查询非银-现金类分期不良 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_ca_fraud is '通过身份证号查询非银-现金类分期资信不佳 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_ca_lost is '通过身份证号查询非银-现金类分期失联 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_ca_overdue is '通过身份证号查询非银-现金类分期短时逾期 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_ca_refuse is '通过身份证号查询非银-现金类分期拒绝 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_cf_bad is '通过身份证号查询非银-消费类分期不良 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_cf_fraud is '通过身份证号查询非银-消费类分期资信不佳 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_cf_lost is '通过身份证号查询非银-消费类分期失联 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_cf_overdue is '通过身份证号查询非银-消费类分期短时逾期 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_cf_refuse is '通过身份证号查询非银-消费类分期拒绝 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_com_bad is '通过身份证号查询非银-代偿类分期不良';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_com_fraud is '通过身份证号查询非银-代偿类分期资信不佳 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_com_lost is '通过身份证号查询非银-代偿类分期失联 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_com_overdue is '通过身份证号查询非银-代偿类分期短时逾期 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_com_refuse is '通过身份证号查询非银-代偿类分期拒绝 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_mc_bad is '通过身份证号查询非银-小贷不良';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_mc_fraud is '通过身份证号查询非银-小贷资信不佳 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_mc_lost is '通过身份证号查询非银-小贷失联 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_mc_overdue is '通过身份证号查询非银-小贷短时逾期 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_mc_refuse is '通过身份证号查询非银-小贷拒绝 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_other_bad is '通过身份证号查询非银-其他不良 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_other_fraud is '通过身份证号查询非银-其他资信不佳 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_other_lost is '通过身份证号查询非银-其他失联 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_other_overdue is '通过身份证号查询非银-其他短时逾期 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_other_refuse is '通过身份证号查询非银-其他拒绝 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_p2p_bad is '通过身份证号查询非银-P2P不良 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_p2p_fraud is '通过身份证号查询非银-P2P资信不佳 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_p2p_lost is '通过身份证号查询非银-P2P失联 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_p2p_overdue is '通过身份证号查询非银-P2P短时逾期 ';
comment on column  af_request_appinfo_his_cold.sl_id_nbank_p2p_refuse is '通过身份证号查询非银-P2P拒绝 ';
comment on column  af_request_appinfo_his_cold.sl_id_p2p_bad is '通过身份证号查询非银(含全部非银类型)不良 ';
comment on column  af_request_appinfo_his_cold.sl_id_p2p_fraud is '通过身份证号查询非银(含全部非银类型)资信不佳 ';
comment on column  af_request_appinfo_his_cold.sl_id_p2p_lost is '通过身份证号查询非银(含全部非银类型)失联 ';
comment on column  af_request_appinfo_his_cold.sl_id_p2p_overdue is '通过身份证号查询非银(含全部非银类型)短时逾期 ';
comment on column  af_request_appinfo_his_cold.sl_id_p2p_refuse is '通过身份证号查询非银(含全部非银类型)拒绝 ';
comment on column  af_request_appinfo_his_cold.sl_id_phone_overdue is '通过身份证号查询电信欠费';
comment on column  af_request_appinfo_his_cold.lm_abnormal is '通过联系人手机查询高危行为';
comment on column  af_request_appinfo_his_cold.lm_bank_bad is '通过联系人手机查询银行(含信用卡)不良 ';
comment on column  af_request_appinfo_his_cold.lm_bank_fraud is '通过联系人手机查询银行(含信用卡)资信不佳 ';
comment on column  af_request_appinfo_his_cold.lm_bank_lost is '通过联系人手机查询银行(含信用卡)失联 ';
comment on column  af_request_appinfo_his_cold.lm_bank_overdue is '通过联系人手机查询银行(含信用卡)短时逾期 ';
comment on column  af_request_appinfo_his_cold.lm_bank_refuse is '通过联系人手机查询银行(含信用卡)拒绝 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_ca_bad is '通过联系人手机查询非银-现金类分期不良 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_ca_fraud is '通过联系人手机查询非银-现金类分期资信不佳 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_ca_lost is '通过联系人手机查询非银-现金类分期失联 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_ca_overdue is '通过联系人手机查询非银-现金类分期短时逾期 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_ca_refuse is '通过联系人手机查询非银-现金类分期拒绝 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_cf_bad is '通过联系人手机查询非银-消费类分期不良 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_cf_fraud is '通过联系人手机查询非银-消费类分期资信不佳 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_cf_lost is '通过联系人手机查询非银-消费类分期失联 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_cf_overdue is '通过联系人手机查询非银-消费类分期短时逾期 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_cf_refuse is '通过联系人手机查询非银-消费类分期拒绝 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_com_bad is '通过联系人手机查询非银-代偿类分期不良 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_com_fraud is '通过联系人手机查询非银-代偿类分期资信不佳 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_com_lost is '通过联系人手机查询非银-代偿类分期失联 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_com_overdue is '通过联系人手机查询非银-代偿类分期短时逾期 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_com_refuse is '通过联系人手机查询非银-代偿类分期拒绝 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_mc_bad is '通过联系人手机查询非银-小贷不良 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_mc_fraud is '通过联系人手机查询非银-小贷资信不佳 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_mc_lost is '通过联系人手机查询非银-小贷失联 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_mc_overdue is '通过联系人手机查询非银-小贷短时逾期 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_mc_refuse is '通过联系人手机查询非银-小贷拒绝 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_other_bad is '通过联系人手机查询非银-其他不良 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_other_fraud is '通过联系人手机查询非银-其他资信不佳 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_other_lost is '通过联系人手机查询非银-其他失联 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_other_overdue is '通过联系人手机查询非银-其他短时逾期 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_other_refuse is '通过联系人手机查询非银-其他拒绝 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_p2p_bad is '通过联系人手机查询非银-P2P不良 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_p2p_fraud is '通过联系人手机查询非银-P2P资信不佳 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_p2p_lost is '通过联系人手机查询非银-P2P失联 ';
comment on column  af_request_appinfo_his_cold.lm_nbank_p2p_overdue is '通过联系人手机查询非银-P2P短时逾期 ';
...
comment on column  af_request_appinfo_his_cold.codenameenglish is '姓名英文风险描述';
comment on column  af_request_appinfo_his_cold.codephoenenglish is '手机英文风险描述';
comment on column  af_request_appinfo_his_cold.zm1_crt_time is '创建时间';
comment on column  af_request_appinfo_his_cold.imeienenglish is '国际移动设备标志';
comment on column  af_request_appinfo_his_cold.imsienenglish is '国际移动用户识别码';
comment on column  af_request_appinfo_his_cold.ipenenglish is 'ip地址';
comment on column  af_request_appinfo_his_cold.macenenglish is '物理地址';
comment on column  af_request_appinfo_his_cold.wifimacenenglish is 'wifi的物理地址';
comment on column  af_request_appinfo_his_cold.result_gmsfhm is '公民身份号码核查结果';
comment on column  af_request_appinfo_his_cold.error_code is '错误代码';
comment on column  af_request_appinfo_his_cold.error_message is '错误描述/缺失必录项描述';
comment on column  af_request_appinfo_his_cold.error_message_col is '缺失必录项字段名称';
comment on column  af_request_appinfo_his_cold.addr is '联系地址';
comment on column  af_request_appinfo_his_cold.busaddr is '单位地址';
comment on column  af_request_appinfo_his_cold.busphone is '公司固定电话';
comment on column  af_request_appinfo_his_cold.certno is '证件号码';
comment on column  af_request_appinfo_his_cold.certnonew is '转换后的证件号码';
comment on column  af_request_appinfo_his_cold.certtype is '证件类型';
comment on column  af_request_appinfo_his_cold.company is '工作单位';
comment on column  af_request_appinfo_his_cold.conttime is '联系时间';
comment on column  af_request_appinfo_his_cold.custname is '客户名称';
comment on column  af_request_appinfo_his_cold.crm_cust_d_date is '数据日期';
comment on column  af_request_appinfo_his_cold.homephone is '住宅固定电话';
comment on column  af_request_appinfo_his_cold.is_credit_card is '是否持有信用卡';
comment on column  af_request_appinfo_his_cold.mobilephone is '联系手机';
comment on column  af_request_appinfo_his_cold.opendate is '最早开户时间';
comment on column  af_request_appinfo_his_cold.phone is '联系电话';
comment on column  af_request_appinfo_his_cold.crm_cust_status is '客户状态';
comment on column  af_request_appinfo_his_cold.workage is '现单位工龄';
comment on column  af_request_appinfo_his_cold.acc_status is '账户状态';
comment on column  af_request_appinfo_his_cold.custid is '客户ID';
comment on column  af_request_appinfo_his_cold.crm_acct_d_date is '数据日期';
comment on column  af_request_appinfo_his_cold.five_class is '五级分类';
comment on column  af_request_appinfo_his_cold.is_due is '是否逾期';
comment on column  af_request_appinfo_his_cold.overdue_day is '逾期天数';
comment on column  af_request_appinfo_his_cold.overdue_num is '当期逾期期数';
comment on column  af_request_appinfo_his_cold.t_overdue_num is '累计逾期期数';
comment on column  af_request_appinfo_his_cold.com_name is '代发单位名称';
comment on column  af_request_appinfo_his_cold.crm_slry_d_date is '数据日期';
comment on column  af_request_appinfo_his_cold.dkdjnum is '当前累计代发笔数';
comment on column  af_request_appinfo_his_cold.dkdjnum_m is '本月代发笔数';
comment on column  af_request_appinfo_his_cold.dkdjnum_y is '本年累计代发笔数';
comment on column  af_request_appinfo_his_cold.l_date is '最后一次代发日期';
comment on column  af_request_appinfo_his_cold.sign_date is '签约时间';
comment on column  af_request_appinfo_his_cold.innetworkmonth is '入网时长(月)';
comment on column  af_request_appinfo_his_cold.arrearage_flag is '是否欠费';
comment on column  af_request_appinfo_his_cold.avg_consumption is '近3个月平均消费(元)';
comment on column  af_request_appinfo_his_cold.phonemoney is '终端价位(元)';
comment on column  af_request_appinfo_his_cold.realname_auth is '实名认证';
comment on column  af_request_appinfo_his_cold.mobile_querytime is '查询时间';
comment on column  af_request_appinfo_his_cold.credit_card_acct_num is '贷记卡账户数';
comment on column  af_request_appinfo_his_cold.number_read is '数字解读';
comment on column  af_request_appinfo_his_cold.opposite_position is '相对位置';
comment on column  af_request_appinfo_his_cold.other_loan_num is '其他贷款笔数';
comment on column  af_request_appinfo_his_cold.person_com_hou_loan_no is '个人商用房贷款笔数';
comment on column  af_request_appinfo_his_cold.person_hou_loan_no is '个人住房贷款笔数';
comment on column  af_request_appinfo_his_cold.semi_cred_acct_num is '准贷记卡账户数';
comment on column  af_request_appinfo_his_cold.ass_dis_balance is '资产处置_余额';
comment on column  af_request_appinfo_his_cold.ass_dis_num is '资产处置_笔数';
comment on column  af_request_appinfo_his_cold.bad_debt_balance is '呆帐_余额';
comment on column  af_request_appinfo_his_cold.deb_c60overd_acct_num is '准贷记卡60天以上透支_笔数/账户数';
comment on column  af_request_appinfo_his_cold.deb_c60overd_over_due_amt is '准贷记卡60天以上透支_单月最高逾期总额/单月最高透支总额';
comment on column  af_request_appinfo_his_cold.debit_co_due_over_due_amt is '贷记卡逾期_单月最高逾期总额/单月最高透支总额';
comment on column  af_request_appinfo_his_cold.gua_compen_balance is '保证人代偿_余额';
comment on column  af_request_appinfo_his_cold.gua_compen_num is '保证人代偿_笔数';
comment on column  af_request_appinfo_his_cold.loan_overdue_acct_num is '贷款逾期_笔数/账户数';
comment on column  af_request_appinfo_his_cold.loan_overdue_longest_over_due is '贷款逾期_最长逾期月数/最长透支月数';
comment on column  af_request_appinfo_his_cold.loan_overdue_over_due_amt is '贷款逾期_单月最高逾期总额/单月最高透支总额';
comment on column  af_request_appinfo_his_cold.birth_day is '出生日期';
comment on column  af_request_appinfo_his_cold.marital_status is '婚姻状况';
comment on column  af_request_appinfo_his_cold.mate_cert_no is '配偶_证件号码';
comment on column  af_request_appinfo_his_cold.mate_cert_type is '配偶_证件类型';
comment on column  af_request_appinfo_his_cold.queryed_cert_no is '被查询者证件号码';
...
comment on column  af_request_appinfo_his_cold.cur_comp_work_stat_y4 is '进入本单位年份4';
comment on column  af_request_appinfo_his_cold.cur_comp_work_stat_y5 is '进入本单位年份5';
comment on column  af_request_appinfo_his_cold.work_info_upd_time1 is '信息更新日期1';
comment on column  af_request_appinfo_his_cold.work_info_upd_time2 is '信息更新日期2';
comment on column  af_request_appinfo_his_cold.work_info_upd_time3 is '信息更新日期3';
comment on column  af_request_appinfo_his_cold.work_info_upd_time4 is '信息更新日期4';
comment on column  af_request_appinfo_his_cold.work_info_upd_time5 is '信息更新日期5';
comment on column  af_request_appinfo_his_cold.job1 is '职业1';
comment on column  af_request_appinfo_his_cold.job2 is '职业2';
comment on column  af_request_appinfo_his_cold.job3 is '职业3';
comment on column  af_request_appinfo_his_cold.job4 is '职业4';
comment on column  af_request_appinfo_his_cold.job5 is '职业5';
comment on column  af_request_appinfo_his_cold.pboc_gjj_info_upd_time is '信息更新日期';
comment on column  af_request_appinfo_his_cold.join_socl_insu_dt is '参缴日期';
comment on column  af_request_appinfo_his_cold.pboc_gjj_join_socl_insu_pl is '参保地';
comment on column  af_request_appinfo_his_cold.monthly_deposit is '月缴存额';
comment on column  af_request_appinfo_his_cold.cur_mpay_amt is '本月缴费金额';
comment on column  af_request_appinfo_his_cold.pboc_yl_info_upd_time is '信息更新日期';
comment on column  af_request_appinfo_his_cold.pboc_yl_join_socl_insu_pl is '参保地';
...
comment on column  af_request_appinfo_his_cold.query_org_1m_sum1 is '最近30天内的查询机构数_贷后管理';
comment on column  af_request_appinfo_his_cold.query_org_1m_sum2 is '最近30天内的查询机构数_贷款审批';
comment on column  af_request_appinfo_his_cold.query_org_1m_sum3 is '最近30天内的查询机构数_信用卡审批';
comment on column  af_request_appinfo_his_cold.query_org_1m_sum4 is '最近30天内的查询机构数_本人查询';
comment on column  af_request_appinfo_his_cold.query_org_1m_sum5 is '最近30天内的查询机构数_担保资格审查';
comment on column  af_request_appinfo_his_cold.query_rec_2y_sum1 is '最近两年内的查询次数_贷后管理';
comment on column  af_request_appinfo_his_cold.query_rec_2y_sum2 is '最近两年内的查询次数_贷款审批';
comment on column  af_request_appinfo_his_cold.query_rec_2y_sum3 is '最近两年内的查询次数_信用卡审批';
comment on column  af_request_appinfo_his_cold.query_rec_2y_sum4 is '最近两年内的查询次数_本人查询';
comment on column  af_request_appinfo_his_cold.query_rec_2y_sum5 is '最近两年内的查询次数_担保资格审查';
comment on column  af_request_appinfo_his_cold.in_6m_case_create_num is '最近6个月的立案数量（逻辑：申请日期-立案日期<=180天，其中申请日期为条码前6位生成)';
comment on column  af_request_appinfo_his_cold.in_6m_case_open_num is '最近6个月的未结案数量（逻辑：申请日期-未结案日期<=180天，其中申请日期为条码前6位生成)';
comment on column  af_request_appinfo_his_cold.in_12m_case_create_num is '最近12个月的立案数量（逻辑：申请日期-立案日期<=360天，其中申请日期为条码前6位生成)';
comment on column  af_request_appinfo_his_cold.in_12m_case_open_num is '最近12个月的未结案数量（逻辑：申请日期-未结案日期<=360天，其中申请日期为条码前6位生成)';
comment on column  af_request_appinfo_his_cold.in_36m_case_create_num is '最近36个月的立案数量（逻辑：申请日期-立案日期<=1080天，其中申请日期为条码前6位生成)';
comment on column  af_request_appinfo_his_cold.in_36m_case_open_num is '最近36个月的未结案数量（逻辑：申请日期-未结案日期<=1080天，其中申请日期为条码前6位生成)';
comment on column  af_request_appinfo_his_cold.in_6m_vehicle_mortgage_num is '最近6个月的车辆(不同的发动机号)抵押数量（逻辑：申请日期-信息更新日期<=180天，其中申请日期为条码前6位生成)';
comment on column  af_request_appinfo_his_cold.in_12m_vehicle_mortgage_num is '最近12个月的车辆(不同的发动机号)抵押数量 （逻辑：申请日期-信息更新日期<=360天，其中申请日期为条码前6位生成)';
comment on column  af_request_appinfo_his_cold.in_36m_vehicle_mortgage_num is '最近36个月的车辆(不同的发动机号)抵押（逻辑：申请日期-信息更新日期<=1080天，其中申请日期为条码前6位生成)';
comment on column  af_request_appinfo_his_cold.reside_info_upd_time1 is '信息更新日期1';
comment on column  af_request_appinfo_his_cold.reside_info_upd_time2 is '信息更新日期2';
comment on column  af_request_appinfo_his_cold.reside_info_upd_time3 is '信息更新日期3';
comment on column  af_request_appinfo_his_cold.reside_info_upd_time4 is '信息更新日期4';
comment on column  af_request_appinfo_his_cold.reside_info_upd_time5 is '信息更新日期5';
comment on column  af_request_appinfo_his_cold.reside_state1 is '居住状况1';
comment on column  af_request_appinfo_his_cold.reside_state2 is '居住状况2';
comment on column  af_request_appinfo_his_cold.reside_state3 is '居住状况3';
comment on column  af_request_appinfo_his_cold.reside_state4 is '居住状况4';
comment on column  af_request_appinfo_his_cold.reside_state5 is '居住状况5';
comment on column  af_request_appinfo_his_cold.outs_loans_loan_corp_number is '未结清贷款_贷款法人机构数/发卡法人机构数';
comment on column  af_request_appinfo_his_cold.outstand_loans_acct_num is '未结清贷款_笔数/账户数';
comment on column  af_request_appinfo_his_cold.outstand_loans_loan_org_number is '未结清贷款_贷款机构数/发卡机构数';
comment on column  af_request_appinfo_his_cold.outstand_loans_6month_ave_pay is '未结清贷款_最近6个月平均应还款/最近6个月平均使用额度/最近6个月平均透支余额';
comment on column  af_request_appinfo_his_cold.outstand_loans_contract_amt is '未结清贷款_合同金额/授信总额';
comment on column  af_request_appinfo_his_cold.no_padc_6month_ave_pay is '未销户准贷记卡_最近6个月平均应还款/最近6个月平均使用额度/最近6个月平均透支余额';
comment on column  af_request_appinfo_his_cold.no_pin_debit_card_contract_amt is '未销户贷记卡_合同金额/授信总额';
comment on column  af_request_appinfo_his_cold.no_pd_card_6month_ave_pay is '未销户贷记卡_最近6个月平均应还款/最近6个月平均使用额度/最近6个月平均透支余额';
comment on column  af_request_appinfo_his_cold.vehicle_query_result is '查询结果';
...
insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_1','EMPTY','RULE','Z','Z2','Z03','Z03_1','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_1','HIT','RULE','Z','Z2','Z03','Z03_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_2','EMPTY','RULE','Z','Z2','Z03','Z03_3','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_2','HIT','RULE','Z','Z2','Z03','Z03_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_3','EMPTY','RULE','Z','Z2','Z03','Z03_4','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_3','HIT','RULE','Z','Z2','Z03','Z03_4','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_4_3','EMPTY','RULE','Z','Z2','Z03','Z03_4','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_4_3','HIT','RULE','Z','Z2','Z03','Z03_4','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_4_4','EMPTY','RULE','Z','Z2','Z03','Z03_4','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_4_4','HIT','RULE','Z','Z2','Z03','Z03_4','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_4_5','EMPTY','RULE','Z','Z2','Z03','Z03_4','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_4_5','HIT','RULE','Z','Z2','Z03','Z03_4','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_6','EMPTY','RULE','Z','Z2','Z03','Z03_4','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_6','HIT','RULE','Z','Z2','Z03','Z03_4','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_8_2','EMPTY','RULE','Z','Z2','Z03','Z03_3','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_8_2','HIT','RULE','Z','Z2','Z03','Z03_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_8_3','EMPTY','RULE','Z','Z2','Z03','Z03_3','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_8_3','HIT','RULE','Z','Z2','Z03','Z03_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_9_1','EMPTY','RULE','Z','Z2','Z03','Z03_3','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_9_1','HIT','RULE','Z','Z2','Z03','Z03_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_12','EMPTY','RULE','Z','Z2','Z03','Z03_3','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_12','HIT','RULE','Z','Z2','Z03','Z03_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_13','EMPTY','RULE','Z','Z2','Z03','Z03_3','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_13','HIT','RULE','Z','Z2','Z03','Z03_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_14_3','EMPTY','RULE','Z','Z2','Z03','Z03_3','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_14_3','HIT','RULE','Z','Z2','Z03','Z03_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_14_5','EMPTY','RULE','Z','Z2','Z03','Z03_3','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_14_5','HIT','RULE','Z','Z2','Z03','Z03_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_15_4','EMPTY','RULE','Z','Z2','Z03','Z03_3','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_15_4','HIT','RULE','Z','Z2','Z03','Z03_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_15_5','EMPTY','RULE','Z','Z2','Z03','Z03_3','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_15_5','HIT','RULE','Z','Z2','Z03','Z03_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_16','EMPTY','RULE','Z','Z2','Z03','Z03_3','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_16','HIT','RULE','Z','Z2','Z03','Z03_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_18','EMPTY','RULE','Z','Z2','Z03','Z03_2','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_18','HIT','RULE','Z','Z2','Z03','Z03_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_19','EMPTY','RULE','Z','Z2','Z03','Z03_2','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_19','HIT','RULE','Z','Z2','Z03','Z03_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_20','EMPTY','RULE','Z','Z2','Z03','Z03_2','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_20','HIT','RULE','Z','Z2','Z03','Z03_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_21','EMPTY','RULE','Z','Z2','Z03','Z03_2','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_21','HIT','RULE','Z','Z2','Z03','Z03_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_22','EMPTY','RULE','Z','Z2','Z03','Z03_2','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_22','HIT','RULE','Z','Z2','Z03','Z03_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_23','EMPTY','RULE','Z','Z2','Z03','Z03_2','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_23','HIT','RULE','Z','Z2','Z03','Z03_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_24','EMPTY','RULE','Z','Z2','Z03','Z03_2','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_24','HIT','RULE','Z','Z2','Z03','Z03_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_25','EMPTY','RULE','Z','Z2','Z03','Z03_2','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_25','HIT','RULE','Z','Z2','Z03','Z03_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_26','EMPTY','RULE','Z','Z2','Z03','Z03_2','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_26','HIT','RULE','Z','Z2','Z03','Z03_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_27','EMPTY','RULE','Z','Z2','Z03','Z03_2','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_27','HIT','RULE','Z','Z2','Z03','Z03_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_28','EMPTY','RULE','Z','Z2','Z03','Z03_2','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_28','HIT','RULE','Z','Z2','Z03','Z03_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_29','EMPTY','RULE','Z','Z2','Z03','Z03_2','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_29','HIT','RULE','Z','Z2','Z03','Z03_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_30','EMPTY','RULE','Z','Z2','Z03','Z03_2','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_30','HIT','RULE','Z','Z2','Z03','Z03_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_31','EMPTY','RULE','Z','Z2','Z03','Z03_2','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_31','HIT','RULE','Z','Z2','Z03','Z03_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_32','EMPTY','RULE','Z','Z2','Z03','Z03_2','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_32','HIT','RULE','Z','Z2','Z03','Z03_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_33','EMPTY','RULE','Z','Z2','Z03','Z03_2','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_33','HIT','RULE','Z','Z2','Z03','Z03_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_34','EMPTY','RULE','Z','Z2','Z03','Z03_2','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_34','HIT','RULE','Z','Z2','Z03','Z03_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_35','EMPTY','RULE','Z','Z2','Z03','Z03_2','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_35','HIT','RULE','Z','Z2','Z03','Z03_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_36','EMPTY','RULE','Z','Z2','Z03','Z03_2','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_36','HIT','RULE','Z','Z2','Z03','Z03_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_37','EMPTY','RULE','Z','Z2','Z03','Z03_1','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_37','HIT','RULE','Z','Z2','Z03','Z03_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_38','EMPTY','RULE','Z','Z2','Z03','Z03_1','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_38','HIT','RULE','Z','Z2','Z03','Z03_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_39','EMPTY','RULE','Z','Z2','Z03','Z03_4','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_39','HIT','RULE','Z','Z2','Z03','Z03_4','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_40','EMPTY','RULE','Z','Z2','Z03','Z03_1','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_40','HIT','RULE','Z','Z2','Z03','Z03_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_42','EMPTY','RULE','Z','Z2','Z03','Z03_1','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_42','HIT','RULE','Z','Z2','Z03','Z03_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_44','EMPTY','RULE','Z','Z2','Z03','Z03_1','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_44','HIT','RULE','Z','Z2','Z03','Z03_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_45','EMPTY','RULE','Z','Z2','Z03','Z03_1','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_45','HIT','RULE','Z','Z2','Z03','Z03_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_46','EMPTY','RULE','Z','Z2','Z03','Z03_1','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_46','HIT','RULE','Z','Z2','Z03','Z03_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_48','EMPTY','RULE','Z','Z2','Z03','Z03_1','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_48','HIT','RULE','Z','Z2','Z03','Z03_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_49','EMPTY','RULE','Z','Z2','Z03','Z03_1','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_49','HIT','RULE','Z','Z2','Z03','Z03_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_50','EMPTY','RULE','Z','Z2','Z03','Z03_1','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_50','HIT','RULE','Z','Z2','Z03','Z03_1','','');

--riskcategory Value of the unknown
insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_52','EMPTY','RULE','Z','Z2','Z03','','NULL','NULL');

--riskcategory Value of the unknown
insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_52','HIT','RULE','Z','Z2','Z03','','','');

--riskcategory Value of the unknown
insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_53','EMPTY','RULE','Z','Z2','Z03','','NULL','NULL');

--riskcategory Value of the unknown
insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_53','HIT','RULE','Z','Z2','Z03','','','');

--riskcategory Value of the unknown
insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_54','EMPTY','RULE','Z','Z2','Z03','','NULL','NULL');

--riskcategory Value of the unknown
insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_54','HIT','RULE','Z','Z2','Z03','','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_65','HIT','RULE','Z','Z2','Z03','Z03_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_66','HIT','RULE','Z','Z2','Z01','Z03_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_67','HIT','RULE','Z','Z2','Z03','Z03_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_68','HIT','RULE','Z','Z2','Z03','Z03_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_70','HIT','RULE','Z','Z2','Z01','Z01_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_71','HIT','RULE','Z','Z2','Z01','Z01_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_73','HIT','RULE','Z','Z2','Z01','Z01_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_75','HIT','RULE','Z','Z2','Z01','Z01_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_80','HIT','RULE','Z','Z2','Z01','Z01_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_82','HIT','RULE','Z','Z2','Z01','Z01_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_83','HIT','RULE','Z','Z2','Z01','Z01_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_85','HIT','RULE','Z','Z2','Z01','Z01_4','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_86','HIT','RULE','Z','Z2','Z01','Z01_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_96','HIT','RULE','Z','Z2','Z03','Z03_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_98','HIT','RULE','Z','Z2','Z03','Z03_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_114','HIT','RULE','Z','Z2','Z03','Z03_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_115','HIT','RULE','Z','Z2','Z03','Z03_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_117','HIT','RULE','Z','Z2','Z03','Z03_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_118','HIT','RULE','Z','Z2','Z03','Z03_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_123','HIT','RULE','Z','Z2','Z03','Z03_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_135','HIT','RULE','Z','Z2','Z03','Z03_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_138','HIT','RULE','Z','Z2','Z03','Z03_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_139','EMPTY','RULE','Z','Z2','Z03','Z03_1','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_139','HIT','RULE','Z','Z2','Z03','Z03_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_140','EMPTY','RULE','Z','Z2','Z03','Z03_1','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_140','HIT','RULE','Z','Z2','Z03','Z03_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_141','EMPTY','RULE','Z','Z2','Z03','Z03_1','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_141','HIT','RULE','Z','Z2','Z03','Z03_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_143','EMPTY','RULE','Z','Z2','Z03','Z03_1','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_143','HIT','RULE','Z','Z2','Z03','Z03_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_145','EMPTY','RULE','Z','Z2','Z03','Z03_2','NULL','NULL');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_PBOC_145','HIT','RULE','Z','Z2','Z03','Z03_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_152_1','HIT','RULE','Z','Z2','Z03','Z03_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_152_2','HIT','RULE','Z','Z2','Z03','Z03_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_152_4','HIT','RULE','Z','Z2','Z03','Z03_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_153_2','HIT','RULE','Z','Z2','Z03','Z03_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_153_3','HIT','RULE','Z','Z2','Z03','Z03_1','','');
...
insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_157','HIT','RULE','Z','Z2','Z01','Z01_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_159','HIT','RULE','Z','Z2','Z01','Z01_4','','');
...
insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_167','HIT','RULE','Z','Z2','Z01','Z01_2','','');
...
insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_169','HIT','RULE','Z','Z2','Z01','Z01_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_173','HIT','RULE','Z','Z2','Z01','Z01_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_174','HIT','RULE','Z','Z2','Z01','Z01_3','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_175','HIT','RULE','Z','Z2','Z01','Z01_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_176','HIT','RULE','Z','Z2','Z01','Z01_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_178','HIT','RULE','Z','Z2','Z01','Z01_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_179','HIT','RULE','Z','Z2','Z01','Z01_2','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_182','HIT','RULE','Z','Z2','Z01','Z03_4','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_198','HIT','RULE','W','W2','W01','W01_4','','');
...
insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_234','HIT','RULE','Z','Z2','Z02','Z02_1','','');

insert into af_risk_level_settings(ruleno, result_type, type, class, riskno, risktype, riskcategory, riskcode, riskdesc) values('RULE_236','HIT','RULE','Z','Z2','Z03','Z03_1','','');
